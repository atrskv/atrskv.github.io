...
<figure>
<img src="/assets/img/posts/impact-map.png" alt="Пример схемы влияния">
...
Возможно, заказчик сказал _что_ нужно сделать и как решение следует внедрить, но совсем не объяснил _зачем_. А если у нас нет ответа на этот вопрос, имеют ли смысл последующие ревью?